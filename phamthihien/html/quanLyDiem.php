...
<html lang="en">
  ...
  <?php include "header.php"; ?>
    ...
    <div class="min">
    <h2><b>DANH SÁCH Điểm SINH VIÊN</b></h2>
            ...
            <?php 
                    $lophp=$_POST['lophp'];
                            ...
                            if(!$conn){
                                ...
                                $sql = "SELECT d.MaSV,d.DiemQT,d.DiemThi,d.DiemTK,d.MaMon from sinhvien sv join diem d JOIN monhoc mh join lophocphan lhp on sv.MaSV=d.MaSV and sv.MaSV=d.MaSV and d.MaMon=mh.MaMon and mh.MaMon=lhp.MaMon WHERE lhp.MaLHP='$lophp'";
                                mysqli_set_charset($conn,'UTF8');
                                $result = mysqli_query($conn,$sql);
                                if (mysqli_num_rows($result)>0){
                                    $bien = 0;
